<template>
  <div id="app">
    <!-- <div id="nav">
      ...
      <router-link to="/notas" v-if="mapGetters">Notas</router-link> |
      <a @click="loggout()" v-if="mapGetters">Salir</a>
      <router-link to="/login" v-if="!mapGetters">Login</router-link> |
    </div> -->
    <div>
